...
object Interaction2 {
  ...
  val colorDeviation : Seq[(Temperature, Color)] = Seq(
    (7.0, Color(red = 0, green = 0, blue = 0)),
    (4.0, Color(red = 255, green = 0, blue = 0)),
    (2.0, Color(red = 255, green = 255, blue = 0)),
    (0.0, Color(red = 255, green = 255, blue = 255)),
    (-2.0, Color(red = 0, green = 255, blue = 255)),
    (-7.0, Color(red = 0, green = 0, blue = 255))
  )
  /**
  ...
  def availableLayers: Seq[Layer] = {
    Seq(
      ...
      Layer(LayerName.Deviations, colorDeviation, 1990 to 2015)
    )
  }
  ...
  def yearSelection(selectedLayer: Signal[Layer], sliderValue: Signal[Year]): Signal[Year] = {
    ...
    val year = min(max(value, bounds.min), bounds.max)
    Signal(year)
  }
